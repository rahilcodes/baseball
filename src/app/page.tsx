...
export const metadata: Metadata = {
  ...
  description:
    "Join BPL Season 1 — Malaysia's first structured adult baseball league. Play from May–July 2026 in Selangor. Register as a player or team today. Limited spots available.",
};
